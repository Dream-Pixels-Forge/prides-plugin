...
If the Prototype phase fails and must be rolled back:

1. **Delete generated PRD**: Remove the PRD document if it was created
2. **Remove planning artifacts**: Delete plans, wireframes, or prototypes generated
3. **Revert brainstorm notes**: Clean up dev_notes/ entries added during this phase
4. **Report to coordinator**: State what was rolled back and why

Prototype artifacts are lightweight — compensation is mostly file deletion.
